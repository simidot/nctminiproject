...
<h2 class="text-center mb-3">엔시티 멤버 등록</h2>
    <form action='${ctxPath}/admin/memberregister' method='post'>
		...
		<div class="form-group row">
            ...
            <div class="col-sm-9">
                <input type="text" class="form-control" id="groupList" name="groupList">
            </div>
        </div>
		

		<button type="submit" class="btn btn-dark d-block mx-auto" onclick="return validateForm();">등록하기</button>
    </form>
</div>
